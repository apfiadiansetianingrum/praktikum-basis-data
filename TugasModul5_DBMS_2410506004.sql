...
--
-- Host: localhost    Database: DBMS11_2410506004
-- ------------------------------------------------------
...
CREATE TABLE `tbpegawai` (
  ...
  PRIMARY KEY (`nip`),
  KEY `gol` (`gol`),
  CONSTRAINT `tbpegawai_ibfk_1` FOREIGN KEY (`gol`) REFERENCES `tbgaji` (`gol`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-03-19 22:46:10
